...
<head>
    ...
    <title>NON-CONSUMABLE ITEMS</title>
            ...
            <li class="nav-item active">
                ...
                <div id="collapseTwo" class="collapse show" aria-labelledby="headingTwo" data-parent="#accordionSidebar">
                    <div class="bg-white py-2 collapse-inner rounded">
                        ...
                        <a class="collapse-item  text-danger active" href="nonConsum_Items.php">Non-Consumable Items</a>
            ...
            <div id="content" class="side">
                ...
                <div class="container-fluid">
                    ...
                    <!-- BEGIN -->
                        ...
                        $result = $mysqli->query("SELECT * FROM borrow_consumable where Student_ID = '$student_num' AND ItemType = 'NON-CONSUMABLE'") or die(mysqli_error($mysqli));
                                        ?>
