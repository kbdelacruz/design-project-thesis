            ...
            <li class="nav-item active">
                ...
                <div id="collapseTwo" class="collapse show" aria-labelledby="headingTwo" data-parent="#accordionSidebar">
                    <div class="bg-white py-2 collapse-inner rounded">
                        ...
                        <a class="collapse-item text-danger active" href="withProd.php">Equipments</a>
                ...
                <div class="container-fluid">
                    ...
                    <!-- BEGIN -->
                        ...
                        <div class="card shadow mb-4">
                                        ...
                                        <div class="col-lg-3">
                                            <div id="dataTable_filter" class="dataTables_filter">
                                                <div class="input-group">
                                                    <input type="search" class="form-control border-danger" onkeyup="searchFun()" id="searchbar"  placeholder="Search..">
                                                </div>
                                            </div>
                                        </div>
                            ...
                            $result = $mysqli->query("SELECT * FROM borrow_equipments where Student_ID = '$student_num'") or die(mysqli_error($mysqli));
                                          ?>
