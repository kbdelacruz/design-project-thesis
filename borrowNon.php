...
<head>
    ...
    <script>
        ...
        function done(event) {
            ...
            var success_table;
            $.ajax({
                url: "php_function/borrow_equipment.php",
                data: {
            ...
            $.ajax({
                ...
                success: function(result) {
                        ...
                        for (var loop = 0; loop < table.length; loop++) {
                            console.log(table[loop]);
                            $.ajax({
                url: "php_function/insert_borrow_equipment.php",
                                                    ...
                                                    <tr role="row" class="odd">
                                                        ...
                                                        <td>
                                                            ...
                                                            <?php if($row['Quantity'] != 0){ ?>
                                                                <input type="text" class="btn btn-outline-success" id="Insert_Quantity<?php echo $row['Product_Number'];  ?>" onkeypress=" digitvalidation(event)" onchange="quantity_borrowConsume(event)">
            ...
            <div class="modal-dialog modal-lg">
                <div class="modal-content">
                    ...
                    <div class="modal-footer">
                        <button type="submit" class="btn btn-primary" onclick="insert(event)" name="modal_done">DONE</button>
                    </div>
                    </form>
                </div>
            </div>
...
function searchFun(){
  var filter, myTable, tr, td, i, td1, td2, td3, td4,td5,td6,txtValue, txtValue1, txtValue2, txtValue3,txtValue4,txtValue5,txtValue6;
